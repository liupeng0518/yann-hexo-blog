---
title: Java网络编程-(1)-NIO基础
date: 2018-05-07 17:29:48
tags:
toc: true
categories: ["java", "网络编程", 'NIO']
---

## Java BIO
传统的网络模式是BIO的模式
![BIO](http://tutorials.jenkov.com/images/java-nio/nio-vs-io-1.png)
...
![NIO](https://image.slidesharecdn.com/javanio2final1-160607115222/95/java-nio2-7-638.jpg?cb=1465300539)
...
![overview-selectors](http://tutorials.jenkov.com/images/java-nio/overview-selectors.png)

关于Channels，如果我一点Linux编程的经验，我们应该也会猜测出Channel中是储存具体的FD（文件句柄）。
![overview-channels-buffers](http://tutorials.jenkov.com/images/java-nio/overview-channels-buffers.png)
...
2. [java NIO详解](http://www.importnew.com/22623.html)
